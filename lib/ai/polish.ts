...
- Begin exactly with the salutation on its own line, then a blank line, then the first paragraph. Like this:

Honourable Sir/Madam,

[First paragraph starts here with a capital letter]`
